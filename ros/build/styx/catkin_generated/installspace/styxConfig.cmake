...
if("FALSE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /home/workspace/Final-Capstone-Project/ros/src/styx)
  set(styx_DEVEL_PREFIX /home/workspace/Final-Capstone-Project/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /home/workspace/Final-Capstone-Project/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/Final-Capstone-Project/ros/install/${idir}'.  ${_report}")
    endif()
