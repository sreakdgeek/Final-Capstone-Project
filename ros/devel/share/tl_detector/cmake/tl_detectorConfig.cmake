...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/workspace/Final-Capstone-Project/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/workspace/Final-Capstone-Project/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/workspace/Final-Capstone-Project/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/Final-Capstone-Project/ros/src/tl_detector/${idir}'.  ${_report}")
    endif()
