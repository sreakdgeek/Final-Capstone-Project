...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /home/workspace/Final-Capstone-Project/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /home/workspace/Final-Capstone-Project/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /home/workspace/Final-Capstone-Project/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/Final-Capstone-Project/ros/src/waypoint_updater/${idir}'.  ${_report}")
    endif()
