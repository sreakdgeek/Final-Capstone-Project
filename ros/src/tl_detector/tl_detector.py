...
class TLDetector(object):
    ...
    def waypoints_cb(self, waypoints):
        rospy.loginfo('Initializing the waypoints on waypoint_tree')
	...
	line_wp_index = None
	    ...
	    diff = len(self.waypoints.waypoints)
            ...
            # Check the closest light that is within the distance that we care about
        ...
        if closest_light:
           ...
           rospy.loginfo('closest light index = ' + str(line_wp_index))
           rospy.loginfo('closest light state = ' + str(state))
